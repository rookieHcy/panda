...
//
//
//    public static String httpsGet(String url, String path, Map<String, String> header) throws Exception {
//        URL u = new URL(url);
...
//    }
//
//    public static String httpsGet(String url, String path) throws Exception {
//        return httpsGet(url, path, new HashMap<String, String>() {{
//            put("User-Agent",
//                    "Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.94 Safari/537.36");
//        }});
//    }
